        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Se connecter</a>
                    <div class="dropdown-menu fade-down m-0">
                         <a href="login.php?fonction=admin" class="dropdown-item">Admin</a>
                        <a href="login.php?fonction=enseignant" class="dropdown-item">Enseignant</a>
                        <a href="login.php?fonction=etudiant" class="dropdown-item">Etudiant</a>
