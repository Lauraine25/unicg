...
include_once('../models/select/sel-mescours.php');
                          ...
                          <div class="col-12 h-100  d-flex justify-content-center align-items-center p-4">
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 bg-dark card p-3 shadow   m-3">
                                    <div class="card-header text-danger d-flex justify-content-between">
                                        ...
                                        <a href="mescours.php" class="btn btn-outline-danger text-white"><b><i class="bi bi-x"></i></b></a>
                                </div>
                                  <div class="card-body py-3  text-white">
                                      Voulez-vous vraiment supprimer l'mescours avec matricule <b><?=$supprimer['matricule']?> </b>"?
                                        <br>
                                        <em class="mt-3 text-danger">NB: cette action est irréversible</em>
                                  </div>
                                  <div class="card-footer">
                                      <a href='../models/del/del-mescours.php?id=<?=$_GET['idsup'] ?>' class="btn btn-outline-danger">Supprimer</a>
                                      <a href="mescours.php" class="btn btn-info">Annuler</a>
                                  </div>
                ...
                <div class="bg-light rounded p-4">
                    <div class="table-responsive">
                          <table class="table datatable ">
                                  <h4 class="p-3 ">Promotion : <?=$prom['nompromotion']?></h4>
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
