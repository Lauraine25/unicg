...
include_once('../models/select/sel-departement.php');
                          ...
                          <div class="col-12 h-100  d-flex justify-content-center align-items-center p-4">
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 bg-dark card p-3 shadow   m-3">
                                    <div class="card-header text-danger d-flex justify-content-between">
                                        ...
                                        <a href="departement.php" class="btn btn-outline-danger text-white"><b><i class="bi bi-x"></i></b></a>
                                </div>
                                  <div class="card-body py-3  text-white">
                                      Voulez-vous vraiment supprimer le departement de   "<b><?=$supprimer['nomdepartement']?> </b>"?
                                        <br>
                                        <em class="mt-3 text-danger">NB: cette action est irréversible</em>
                                  </div>
                                  <div class="card-footer">
                                      <a href='../models/del/del-departement.php?id=<?=$_GET['idsup'] ?>' class="btn btn-outline-danger">Supprimer</a>
                                      <a href="departement.php" class="btn btn-info">Annuler</a>
                                  </div>
                                  ...
                                  <h5 class="card-title text-center "><?=$titre?></h5>
                                    <div class="row">
                                         ...
                                         <div class="col-xl-12 col-lg-12 col-md-12  col-sm-12 p-3">
                                            ...
                                            <input autocomplete="off" required type="text" class="form-control" placeholder="Ex:economie politique"  name="nom" <?php if(isset($_GET['id'])){ ?> value="<?=$modData['nomdepartement']?>" <?php } ?>> 
                                        </div>
                                         <div class=" col-xl-12 col-lg-12 col-md-12  col-sm-12 p-3">
                                            <label for="">faculte</span></label>
                                            <select name="faculte" id="faculte" class="form-control ">
                                                <?php 
                                                while($faculte=$SelFaculte->fetch()){
                                                if(isset($_GET['id'])){ ?>
                                               
                                                    <option <?php if($modData['idfaculte']==$faculte['id']){ ?> Selected <?php } ?> value="<?=$faculte['id']?>"><?=$faculte['nom']?></option>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12  col-sm-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4  col-sm-4">
                                                <a href="departement.php" class="btn btn-dark p-2  mt-1 w-100">Annuler</a>
                                            </div>
                                        </div>
                                        <?php }else {?>
                ...
                <div class="bg-light rounded p-4">
                    <div class="table-responsive">
                          <table class="table datatable ">
                                  <h4 class="p-3 ">Liste des departement</h4>
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
