...
include_once('../models/select/sel-inscription.php');
                          ...
                          <div class="col-12 h-100  d-flex justify-content-center align-items-center p-4">
                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 bg-dark card p-3 shadow   m-3">
                                    <div class="card-header text-danger d-flex justify-content-between">
                                        ...
                                        <a href="inscription.php" class="btn btn-outline-danger text-white"><b><i class="bi bi-x"></i></b></a>
                                </div>
                                  <div class="card-body py-3  text-white">
                                      Voulez-vous vraiment supprimer l'inscription avec matricule <b><?=$supprimer['matricule']?> </b>"?
                                        <br>
                                        <em class="mt-3 text-danger">NB: cette action est irréversible</em>
                                  </div>
                                  <div class="card-footer">
                                      <a href='../models/del/del-inscription.php?id=<?=$_GET['idsup'] ?>' class="btn btn-outline-danger">Supprimer</a>
                                      <a href="inscription.php" class="btn btn-info">Annuler</a>
                                  </div>
                                         ...
                                         <div class=" col-xl-12 col-lg-12 col-md-12  col-sm-12 p-3">
                                            ...
                                            <select name="etudiant" id="etudiant" class="form-control ">
                                                ...
                                                if(isset($_GET['id'])){ ?>
                                                    ...
                                                    <option <?php if($modData['idetudiant']==$etudiant['id']){ ?> Selected <?php } ?> value="<?=$etudiant['id']?>"><?=$etudiant['nom']." ".$etudiant['postnom']." ".$etudiant['prenom']?></option>
                ...
                <div class="bg-light rounded p-4">
                    <div class="table-responsive">
                          <table class="table datatable ">
                                  <h4 class="p-3 ">Liste des inscriptions</h4>
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
