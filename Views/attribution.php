...
include_once('../models/select/sel-attribution.php');
                                  ...
                                  <h5 class="card-title text-center "><?=$titre?></h5>
                                    <div class="row">
                                         ...
                                         <div class=" col-xl-12 col-lg-12 col-md-12  col-sm-12 p-3">
                                            <label for="">enseignant</span></label>
                                            <select name="enseignant" id="enseignant" class="form-control ">
                                                <?php 
                                                while($enseignant=$Selenseignant->fetch()){
                                                if(isset($_GET['id'])){ ?>
                                               
                                                    <option <?php if($modData['idenseignant']==$enseignant['matricule']){ ?> Selected <?php } ?> value="<?=$enseignant['id']?>"><?=$enseignant['nom']." ".$enseignant['postnom']." ".$enseignant['prenom']?></option>
                                                 
                                                <?php }else{?>
                                                    <option value="<?=$enseignant['matricule']?>"><?=$enseignant['nom']." ".$enseignant['postnom']." ".$enseignant['prenom']?></option>
                                        ...
                                        <div class=" col-xl-12 col-lg-12 col-md-12  col-sm-12 p-3">
                                            <label for="">semestre</span></label>
                                            <select name="semestre" id="semestre" class="form-control ">
                                                <?php 
                                                while($semestre=$Selsemestre->fetch()){
                                                if(isset($_GET['id'])){ ?>
                                               
                                                    <option <?php if($modData['id_semestre']==$semestre['id_semestre']){ ?> Selected <?php } ?> value="<?=$semestre['id_semestre']?>"><?=$semestre['nomsemestre']?></option>
                                                 
                                                <?php }else{?>
                                                    <option value="<?=$semestre['id_semestre']?>"><?=$semestre['nomsemestre']?></option>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12  col-sm-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-4  col-sm-4">
                                                <a href="attribution.php" class="btn btn-dark p-2  mt-1 w-100">Annuler</a>
                                            </div>
                                        </div>
                                        <?php }else {?>
                ...
                <div class="bg-light rounded p-4">
                    <div class="table-responsive">
                          <table class="table datatable ">
                                  <h4 class="p-3 ">Liste des attributions</h4>
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
